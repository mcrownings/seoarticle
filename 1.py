...
def generate_content(prompt, previous_content="", language="English", keywords=""):
    ...
    if language == "English":
        system_message = {"role": "system", "content": "Craft detailed, engaging, and SEO-optimized content. You should speak with a confident, knowledgeable, neutral and clear tone of voice. Never write conclusions. ALWAYS include ACTUAL brand-names."}
    else:
